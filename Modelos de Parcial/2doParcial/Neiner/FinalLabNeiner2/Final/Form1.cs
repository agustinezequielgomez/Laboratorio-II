...
namespace SP
{
    ...
    public partial class frmFinal : Form
    {
        ...
        {
            MessageBox.Show("Lucas Ezequiel Carreño Massa");
        }
        ...
        {
            MessageBox.Show("Simulacion de funcionamiento de AgregarBD.");
        ...
        {
            MessageBox.Show("Simulacion de funcionamiento de MostrarBD.");
        ...
        private void btnPunto7_Click(object sender, EventArgs e)
        {
            ...
            g.ElementosParesEvent+= new DelPar(ManejadorPares);
            g1.ElementosParesEvent += new DelPar(ManejadorPares);
        ...
        {
            string item=string.Format("Agregue un elemento par \n{0} ", sender.ToString());
            MessageBox.Show(item);
        }

        private void btnPunto8_Click(object sender, EventArgs e)
        {
            Thread t1 = new Thread(ProbarTodo);
            t1.Start();
            //Implementar hilo
        }
