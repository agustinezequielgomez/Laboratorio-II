...
namespace Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Alumno a2 = new Alumno(25, "B", "B", "90000900", Persona.ENacionalidad.Extranjero, Universidad.EClases.Legislacion, Alumno.EEstadoCuenta.Deudor);
            Profesor p1 = new Profesor(50, "P", "P", "90000901", Persona.ENacionalidad.Extranjero);
